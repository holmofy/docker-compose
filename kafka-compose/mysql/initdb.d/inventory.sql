...
VALUES (default,"Sally","Thomas","sally.thomas@acme.com",1),
       (default,"George","Bailey","gbailey@foobar.com",1),
       (default,"Edward","Walker","ed@walker.com",1),
       (default,"Anne","Kretchmar","annek@noanswer.org",1);
